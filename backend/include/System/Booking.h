...
class FieldEvent{
    ...
    [[nodiscard]] std::vector<std::string> is_available(const std::string& start_time, const std::string& end_time)const;

    private:
    [[nodiscard]] bool is_available(const std::string& start_time, const std::string& end_time, const std::vector<BookEvent>& book_info)const;
};
...
private:
    ...
    [[nodiscard]] std::vector<std::string> xpathQuery(const std::string& xmlContent, const std::string& xpathExpr)const;
...
public:
    ...
    [[nodiscard]] FieldEvent retrieve_field_info(const std::string& field, const std::string& start_time, const std::string& end_time)const;
